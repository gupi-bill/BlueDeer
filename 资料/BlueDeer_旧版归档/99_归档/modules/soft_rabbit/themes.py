...
_SERIES_PALETTES: dict[str, dict[str, ThemePalette]] = {
    "retro_console": {
        "dark": ThemePalette(
            bg=Color(15, 15, 30),
            panel=Color(30, 30, 50),
            border=Color(100, 100, 140),
            text=Color(230, 230, 240),
            text_dim=Color(130, 130, 160),
            title=Color(255, 220, 80),
            success=Color(100, 220, 100),
            warning=Color(255, 180, 60),
            error=Color(240, 80, 80),
            info=Color(100, 180, 240),
            accent=Color(200, 120, 240),
        ),
        "light": ThemePalette(
            bg=Color(240, 240, 245),
            panel=Color(225, 225, 235),
            border=Color(100, 100, 140),
            text=Color(30, 30, 50),
            text_dim=Color(110, 110, 130),
            title=Color(180, 140, 30),
            success=Color(40, 160, 60),
            warning=Color(200, 130, 30),
            error=Color(200, 50, 50),
            info=Color(40, 120, 200),
            accent=Color(150, 80, 200),
        ),
    },
    "industrial_console": {
        "dark": ThemePalette(
            bg=Color(20, 25, 20),
            panel=Color(30, 38, 30),
            border=Color(90, 110, 90),
            text=Color(200, 220, 200),
            text_dim=Color(110, 130, 110),
            title=Color(180, 255, 180),
            success=Color(80, 200, 100),
            warning=Color(220, 200, 60),
            error=Color(240, 120, 80),
            info=Color(120, 200, 180),
            accent=Color(180, 220, 140),
        ),
        "light": ThemePalette(
            bg=Color(230, 235, 230),
            panel=Color(215, 225, 215),
            border=Color(80, 110, 80),
            text=Color(30, 45, 30),
            text_dim=Color(100, 120, 100),
            title=Color(60, 130, 60),
            success=Color(40, 150, 60),
            warning=Color(170, 150, 30),
            error=Color(190, 80, 40),
            info=Color(40, 130, 120),
            accent=Color(110, 150, 70),
        ),
    },
    "dark_forest": {
        "dark": ThemePalette(
            bg=Color(12, 20, 16),
            panel=Color(20, 35, 25),
            border=Color(60, 90, 70),
            text=Color(200, 220, 200),
            text_dim=Color(100, 120, 105),
            title=Color(180, 230, 140),
            success=Color(120, 220, 120),
            warning=Color(230, 200, 100),
            error=Color(240, 100, 80),
            info=Color(140, 200, 220),
            accent=Color(180, 200, 140),
        ),
        "light": ThemePalette(
            bg=Color(235, 245, 238),
            panel=Color(220, 235, 225),
            border=Color(70, 110, 85),
            text=Color(25, 45, 30),
            text_dim=Color(95, 115, 100),
            title=Color(80, 140, 50),
            success=Color(50, 160, 70),
            warning=Color(180, 150, 40),
            error=Color(190, 70, 50),
            info=Color(50, 130, 160),
            accent=Color(110, 140, 70),
        ),
    },
    "amber_crt": {
        "dark": ThemePalette(
            bg=Color(20, 12, 5),
            panel=Color(35, 22, 8),
            border=Color(120, 80, 30),
            text=Color(255, 200, 100),
            text_dim=Color(160, 120, 60),
            title=Color(255, 230, 140),
            success=Color(220, 180, 80),
            warning=Color(255, 200, 60),
            error=Color(255, 120, 60),
            info=Color(220, 160, 80),
            accent=Color(255, 180, 100),
        ),
        "light": ThemePalette(
            bg=Color(250, 240, 220),
            panel=Color(240, 225, 195),
            border=Color(140, 100, 50),
            text=Color(80, 50, 20),
            text_dim=Color(130, 100, 60),
            title=Color(150, 90, 20),
            success=Color(150, 110, 30),
            warning=Color(180, 130, 30),
            error=Color(190, 80, 30),
            info=Color(150, 100, 40),
            accent=Color(170, 110, 40),
        ),
    },
    "minimal_office": {
        "dark": ThemePalette(
            ...
            border=Color(70, 70, 78),
            text=Color(220, 220, 225),
            text_dim=Color(130, 130, 138),
            title=Color(230, 230, 240),
            success=Color(100, 200, 130),
            warning=Color(230, 190, 90),
            error=Color(230, 100, 100),
            info=Color(100, 170, 230),
            accent=Color(180, 180, 200),
        ),
        "light": ThemePalette(
            bg=Color(252, 252, 254),
            panel=Color(242, 242, 246),
            border=Color(180, 180, 188),
            text=Color(40, 40, 48),
            text_dim=Color(120, 120, 130),
            title=Color(30, 30, 40),
            success=Color(50, 160, 80),
            warning=Color(180, 140, 40),
            error=Color(190, 60, 60),
            info=Color(50, 110, 180),
            accent=Color(90, 90, 110),
        ),
    },
    "cyber_pixel": {
        "dark": ThemePalette(
            bg=Color(15, 8, 30),
            panel=Color(28, 15, 50),
            border=Color(120, 60, 200),
            text=Color(220, 200, 255),
            text_dim=Color(130, 110, 170),
            title=Color(255, 100, 220),
            success=Color(80, 255, 180),
            warning=Color(255, 200, 80),
            error=Color(255, 60, 120),
            info=Color(80, 200, 255),
            accent=Color(200, 80, 255),
        ),
        "light": ThemePalette(
            bg=Color(245, 235, 255),
            panel=Color(232, 220, 250),
            border=Color(130, 70, 200),
            text=Color(50, 25, 80),
            text_dim=Color(115, 95, 150),
            title=Color(180, 40, 150),
            success=Color(40, 160, 100),
            warning=Color(180, 130, 30),
            error=Color(190, 50, 90),
            info=Color(40, 110, 180),
            accent=Color(140, 50, 180),
        ),
    },
}
...
class ThemeSyncEngine:
    ...
    def export_config(self, theme: Theme | None = None) -> dict[str, Any]:
        ...
        return {
            ...
            "anim_intensity": t.anim_intensity,
...
class RoleSkinRegistry:
    ...
    def get_outfit_frame(self, agent_id: str, state: str, frame_idx: int = 0) -> str:
        ...
        frames = (
            skin.outfit_frames.get(state) or skin.outfit_frames.get("working") or ["?"]
        )
...
class BrightnessAdapter:
    ...
    def apply_to_palette(
        self, palette: ThemePalette, brightness: float
    ) -> ThemePalette:
        """按亮度系数调整整块色板。"""
...
class ThemeManager:
    ...
    def auto_adjust_brightness(self, hour: int | None = None) -> Theme:
        ...
        return Theme(
            ...
            anim_intensity=base.anim_intensity,
