...
def _parse_serve_phase(snapshot: str, task_type: str = "serve") -> dict:
    ...
    if re.search(r"Ollama API ready on port\s+\d+", flat, re.IGNORECASE):
        return {"phase": "ready", "status": "ready"}
...
def _diagnose_serve_output(text: str) -> dict | None:
    ...
    patterns = [
        ...
        (
            ...
            [
                {
                    "label": "install mflux in Cookbook Dependencies",
                    "op": "dependency",
                    "package": "mflux",
                }
            ],
        ...
        (
            ...
            [
                {
                    "label": "build mlx-lama-swift bridge and put odysseus-mlx-inpaint or mlx-lama-serve on PATH",
                    "op": "dependency",
                    "package": "mlx_lama_swift",
                }
            ],
        ),
        (
            ...
            [
                {
                    "label": "build mlx-ddcolor-swift bridge and put odysseus-mlx-colorize or mlx-ddcolor-serve on PATH",
                    "op": "dependency",
                    "package": "mlx_ddcolor_swift",
                }
            ],
        ),
        (
    ...
    if re.search(
        ...
        r"Application startup complete|GET /v1/|Uvicorn running on", tail, re.IGNORECASE
    ):
        return {
