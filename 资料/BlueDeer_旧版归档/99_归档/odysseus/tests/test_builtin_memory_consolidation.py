...
@pytest.mark.asyncio
async def test_consolidate_memory_removes_near_duplicates_before_ai(
    monkeypatch, tmp_path
):
    from src import constants, llm_core, task_endpoint
        ...
        [
            {
                "id": "a",
                "owner": "alice",
                "text": "User prefers bullet points when explaining.",
                "category": "preference",
            },
            {
                "id": "b",
                "owner": "alice",
                "text": "User prefers bulletpoints when explaining",
                "category": "preference",
                "pinned": True,
            },
            {
