...
class GitHubKnowledge:
    ...
    _BUILTIN_PROJECTS: list[dict[str, Any]] = [
        ...
        {"name": "FastAPI", "url": "https://github.com/fastapi/fastapi",
         ...
         "category": "framework", "tags": ["web", "api", "async", "python"],
        ...
        {"name": "LangChain", "url": "https://github.com/langchain-ai/langchain",
         ...
         "category": "framework", "tags": ["llm", "ai", "chain", "agent"],
         "key_insights": ["链式调用模式", "Agent 工具集成", "Prompt 模板管理"]},
        {"name": "CrewAI", "url": "https://github.com/joaomdmoura/crewAI",
         "description": "多 Agent 协作框架，角色分工与任务路由",
         "category": "framework", "tags": ["multi-agent", "collaboration", "ai"],
        ...
        {"name": "AutoGen", "url": "https://github.com/microsoft/autogen",
         ...
         "category": "framework", "tags": ["multi-agent", "conversation", "microsoft"],
        ...
        {"name": "Clean Architecture", "url": "https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html",
         ...
         "category": "architecture", "tags": ["architecture", "ddd", "solid"],
         "key_insights": ["依赖反转原则", "用例驱动", "边界隔离"]},

        # ---- 算法/数据结构 ----
        {"name": "Bloom Filter", "url": "https://github.com/bitly/dablooms",
         "description": "布隆过滤器，高效集合成员判断",
         "category": "algorithm", "tags": ["probabilistic", "set", "memory"],
         "key_insights": ["概率性数据结构", "假阳性控制", "空间效率"]},
        {"name": "Skip List", "url": "https://en.wikipedia.org/wiki/Skip_list",
         "description": "跳表，有序数据结构，支持 O(log n) 查找",
         "category": "algorithm", "tags": ["data-structure", "ordered", "log-n"],
         "key_insights": ["多层索引", "概率平衡", "范围查询优化"]},
        {"name": "LSM Tree", "url": "https://github.com/google/leveldb",
         "description": "日志结构合并树，LSM 存储引擎核心",
         "category": "algorithm", "tags": ["storage", "write-optimized", "nosql"],
         "key_insights": ["顺序写入", "层级合并", "写放大控制"]},

        # ---- 模板 ----
        {"name": "Cookiecutter", "url": "https://github.com/cookiecutter/cookiecutter",
         "description": "项目模板生成器，从模板创建新项目",
         "category": "template", "tags": ["template", "scaffold", "automation"],
         "key_insights": ["模板化生成", "变量替换", "钩子机制"]},
        {"name": "uv", "url": "https://github.com/astral-sh/uv",
         "description": "极速 Python 包管理器，替代 pip",
         "category": "tool", "tags": ["python", "package-manager", "performance"],
